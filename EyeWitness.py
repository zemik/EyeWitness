...
def create_cli_parser():
    ...
    report_options.add_argument("-b", "--no-bootstrap",
                                action="store_true",
                                help="Do not include Bootstrap CSS in generated HTML reports")
...
def single_mode(cli_parsed):
    ...
    try:
        ...
        web_index_head = create_web_index_head(cli_parsed.date, cli_parsed.time, cli_parsed)
